 ...
 * IFilterInput is a class for filtering input from any data source

 *

 * Forked from the php input filter library by: Subikar Burman <subikar@itcslive.com>

 * Original Contributors: Gianpaolo Racca, Ghislain Picard, Marco Wandschneider, Chris Tobin and Andrew Eddie.

 *

 * @package 	iTCSLive.Framework
...

{
...

	{
		...
		$source = preg_replace_callback('/&#(\d+);/me', "utf8_encode(chr(\\1))", $source); // decimal notation

		// convert hex

		$source = preg_replace_callback('/&#x([a-f0-9]+);/mei', "utf8_encode(chr(0x\\1))", $source); // hex notation
