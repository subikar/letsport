          ...
          <div class="btn-toolbar">
            <div class="btn-group" dropdown="">
			 <div class="btn btn-default dropdown-toggle btn-save">
			  ...
			  <div class="btn btn-default dropdown-toggle btn-save">
			  	<a href="index.php?view=subscriber">Cancel</a>
			  </div>
            </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="panel panel-gray">
			  ...
			  <input type="hidden" id="work_id" name="subscriber_id" value="<?php echo (int)$WorkData->subscriber_id; ?>" />
