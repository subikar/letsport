...
<meta charset="utf-8">
<title>Let's port</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link href="http://192.168.9.100/custom/letsport/templates/itcslive/css/bootstrap.css" rel="stylesheet" type="text/css">
							...
							<div class="panel-body pan">
								...
								<div class="form-body pal">
									...
									<div class="form-actions text-right pal">
										<button type="button" name="btn_next" id="btn_next" class="btn btn-primary">Next</button>
										&nbsp;<button type="button" class="btn btn-primary" onclick="window.location = 'https://freightbazaar.com/';" name="cancel">cancel</button>
									</div>
