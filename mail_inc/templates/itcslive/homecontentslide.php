...
<div class="form-group">
										<div class="input-group col-sm-4 inline">
													...
													<input id="from_location" placeholder="From Location" type="text" name="from_location" class="form-control search-inputs" autocomplete="off">
												...
												<div class="input-group col-sm-4 inline" >
													...
													<input id="to_location" placeholder="To Location" name="to_location" type="text" class="form-control search-inputs" autocomplete="off">
													<input type="hidden" name="to_lat" id="load_to_lat" value="">
													<input type="hidden" name="to_lng" id="load_to_lng" value="">
												</div>
												<div class="input-group col-sm-4 inline" >
													<span class="input-group-addon" id="basic-addon1"><i class="fa fa-calendar"></i></span>
													<input type="text" value="23-06-2016" id="availability_date" name="availability_date" class="form-control search-inputs" placeholder="Availability Date">
													<span class="input-group-addon right-btn-load" style="min-width:65px;padding: 0px;background:#f78320;">
											      	<input type="submit" value="Search" id="find_load" name="find_load" class="btn btn-primary" style="width:100%;height:100%;background:#f78320;"> 
											      	</span>
												</div>
		</div>
</div>
