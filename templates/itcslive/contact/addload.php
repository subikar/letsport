...
<div class="container popupform">
			...
			<div class="grid_4">
				 ...
				 <input name="to_location" id="to_location" title="Enter To Location" value="" class="input-xlarge required-entry validate-email validate_me span12 placepicker" type="email" placeholder="Enter To Location" data-type="geo_code">
			...
			<div class="grid_4">
				 ...
				 <label class="control-label" for="email">Truck quantity:</label>

				 <input type="text" name="name" value=""  id="name" placeholder="Truck quantity" class="input-xlarge required-entry validate-email validate_me span12" required="">
			...
			<div class="grid_4">
				 ...
				 <input type="text" name="name" value=""  id="name" placeholder="Time" class="input-xlarge required-entry validate-email validate_me span12" required="">
